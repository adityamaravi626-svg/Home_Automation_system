...
const char DEVICE_LOGIN_NAME[]  = "0633f0cc-13ce-4641-8dd3-204b379a4b07"; //Enter DEVICE ID

const char SSID[]               = "Tenda_A7A758";    //Enter WiFi SSID (name)
const char PASS[]               = "Abhi@123";    //Enter WiFi password
const char DEVICE_KEY[]         = "DZa5BUOfU!IDeFQfrIuZmTE?b";    //Enter Secret device password (Secret Key)

#define DHTPIN              15 //D4  pin connected with DHT
